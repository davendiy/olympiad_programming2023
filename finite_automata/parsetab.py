...
_lr_productions = [
  ...
  ('expr -> expr PLUS term','expr',3,'p_expr','example_lang.py',32),
  ('expr -> expr MINUS term','expr',3,'p_expr','example_lang.py',33),
  ('expr -> term','expr',1,'p_expr_term','example_lang.py',42),
  ('term -> term TIMES factor','term',3,'p_term','example_lang.py',48),
  ('term -> term DIVIDE factor','term',3,'p_term','example_lang.py',49),
  ('term -> factor','term',1,'p_term_factor','example_lang.py',58),
  ('factor -> NUM','factor',1,'p_factor','example_lang.py',65),
  ('factor -> LPAREN expr RPAREN','factor',3,'p_factor_group','example_lang.py',72),
]
